...
locals {
  ...
  foundation_parameters_2 = {
    "management.organization" : {
      ...
      "account_access_role" : string
      "core_account_ids" : {
        "org_management" : string
        "security" : string
        "connectivity" : string
        "log_archive" : string
      ...
      "aws_organization" = {
        "aws_service_access_principals" : string # "access-analyzer.amazonaws.com,backup.amazonaws.com,cloudtrail.amazonaws.com,compute-optimizer.amazonaws.com,..."
        "enabled_policy_types" : string  # "AISERVICES_OPT_OUT_POLICY,SERVICE_CONTROL_POLICY,TAG_POLICY"
      }
      "delegation_target_account_id" : {
        "guardduty" : string
        "securityhub" : string
        "fms" : string
        "cloudtrail" : string
        "config" : string
        "member.org.stacksets.cloudformation" : string
      }      
    }
    ...
    "security.auto_remediation" = {
      "account_baseline" = {
        "iam_role_name" : string // "foundation-security--auto-remediation--role"
        "iam_role_path" : "/"
        "iam_role_boundary_policy" : "n/a"
      }
...
EOT
  ...
  foundation_parameters_3 = {
    "management.organization" : {
      "main_region" : "eu-central-1"
      "active_regions" : join(",", ["eu-central-1", "eu-central-2"])
      "account_access_role" : "OrganizationAccountAccessRole"
    }
    "management.organization.core_account_ids" : {
      "org_management" : "123456789000"
      "security" : "123456789000"
      "connectivity" : "123456789000"
      "log_archive" : "123456789000"
    ...
    "management.organization.core_account_tags" : {
      "org_management" : jsonencode({ tag1 : "value", tag2 : "value" })
      "security" : jsonencode({})
      "connectivity" : jsonencode({})
      "log_archive" : jsonencode({})
    }
    "management.organization.aws_organization" = {
    ...
    "management.organization.delegations.target_account_id" : {
    ...
    "security.account_hardening.account_baseline" = {
      "iam_role_name" : "foundation-security--account-hardening--role"
      "iam_role_path" : "/"
      "iam_role_boundary_policy" : "n/a"
    }
